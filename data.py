...
def find_ny930_candle(data):
    ...
    """
    ny930_candle = data.between_time('09:30', '09:30')
...
def display_results():
    ...
    Also displays the number of wins, losses, and the total R made.
    """
    ...
    if connect_mt5():
        ...
        if data is not None:
            ...
            # Calculate total R
            total_r = (wins * 3) - losses

            # Display summary of wins, losses, and total R
            results_text.insert(tk.END, "\nSummary:\n")
